...
plot(bats.with.fire, breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1), colNA="black", main= "Fire")
plot(bats.without.fire, breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1), colNA="black", main= "Not Fire")
```
...
```{r, echo=FALSE, cache=TRUE}
best.My.Vo2
confint(best.My.Vo2, type='det', method = 'normal')
confint(best.My.Vo2, type='det', method = 'profile')
lc <- linearComb(best.My.Vo2['det'],c(1,0.5))
btlc <- backTransform(lc)
btlc
summary(btlc)

confint(btlc, level = 0.9)
re <- ranef(best.My.Vo2)
